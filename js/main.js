...
const translations = {
  it: {
    ...
    about_label: 'La nostra cucina',
    about_title: '',
    about_text1: 'Un equilibrio tra tradizione e creatività. <br> La cucina dell’Osteria Sant’Eustorgio è un viaggio tra Milano e il Piemonte, dove gli ingredienti locali incontrano la cura del dettaglio. Tutto è preparato al momento, con materie prime selezionate e un tocco moderno che non snatura la tradizione.',
    about_cta: 'Scopri di più',
    highlights_label: 'nel cuore di Milano',
    about_text2: "Con vista sulla storia e profumo di casa.La cucina del Ristorante Sant'Eustorgio è un viaggio tra Milano e il Piemonte, dove gli ingredienti locali incontrano la cura del dettaglio. Tutto è preparato al momento, con materie prime selezionate e un tocco moderno che non snatura la tradizione.",
    ...
    cta_sub: 'Un\'esperienza unica nella cornice di Piazza Sant\'Eustorgio',
    cta_btn1: 'Prenota ora',
    cta_btn2: 'Richiedi informazioni',
    ft_orari: 'Orari e contatti',
    ...
    cant_intro_title: '',
    cant_intro_p1: 'L’azienda Medolago Albani si trova sulle colline di Redona in Comune di Trescore Balneario in provincia di Bergamo.I 30 ettari vitati hanno esposizione ottimale in una conca rivolta a mezzogiorno. I terreni calcareo-argilllosi e l’ottimo micro-clima favoriscono da secoli la coltivazione della vite.La nostra passione per i vini ci a portato, inoltre, a conoscere anche le altre cantine e avere una selezione ricercata. La cantina Medolago Albani, con i suoi 30 ettari vitati sulle colline di Trescore Balneario, nella bergamasca, non è una semplice etichetta sul menù: è parte integrante della filosofia del ristorante.',
